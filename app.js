...
var budgetController = (function(){
	...
	Expense.prototype.calcPercenteage = function(totalIcome){
	...
	Expense.prototype.getPercentage = function(argument){
	...
	return {
		...
		calculatePercentages: function(){
			...
			data.allItems.exp.forEach(function(cur){
				cur.calcPercenteage(data.totals.inc)
			})
...
var UIController = (function(){
	...
	return {
		...
		displayBudget: function(obj){
			...
			document.querySelector(DOMStrings.incomeLabel).textContent = formateNumber(obj.totalIncome, 'inc')
			document.querySelector(DOMStrings.expenseLabel).textContent = formateNumber(obj.totalExpense, 'exp')
...
var controller = (function(budgetCtrl, UICtrl){
	...
	var ctrlDeleteItem = function(e){
		...
		if(itemID){
			...
			// 1. delete the item from data struacture
